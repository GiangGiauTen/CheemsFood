  ...
  async seed() {
    ...
    const khoaiTayXaoCaChua = await this.prisma.recipe.create({
      data: {
        ...
        imgUrl:
          'https://cdn.tgdd.vn/Files/2023/01/11/1502651/huong-dan-lam-khoai-tay-xao-ca-chua-ai-an-cung-thich-202301111815046448.jpg',
        description: `Bước 1: Sơ chế nguyên liệu
    ...
    const lauCaChep = await this.prisma.recipe.create({
      data: {
        ...
        imgUrl:
          'https://cdn.tgdd.vn/Files/2020/03/09/1240990/huong-dan-cach-nau-lau-ca-chep-gion-ngon-dam-da-2-760x367.jpg',
    ...
    const lauRieuCuaBapBoSuonSun = await this.prisma.recipe.create({
      data: {
        ...
        imgUrl:
          'https://cdn.tgdd.vn/Files/2021/09/03/1379936/cach-lam-lau-rieu-cua-suon-sun-thom-ngon-hap-dan-cho-ngay-cuoi-tuan-202201100004478124.jpeg',
        description: `Bước 1: Sơ chế nguyên liệu
    ...
    const thitKhoChayCanh = await this.prisma.recipe.create({
      data: {
        ...
        imgUrl:
          'https://cdn.tgdd.vn/2021/01/CookRecipe/Avatar/thit-ba-chi-rang-chay-canh-thumbnail-1.jpg',
        description: `"Bước 1: Sơ chế nguyên liệu
    ...
    const caChepKhoRiengMienBac = await this.prisma.recipe.create({
      data: {
        ...
        imgUrl:
          'https://i-giadinh.vnecdn.net/2021/08/02/Cchpkhoring-1627901968-1318-1627902150.jpg',
    ...
    const hauChienTrung = await this.prisma.recipe.create({
      data: {
        ...
        imgUrl:
          'https://cdn.tgdd.vn/Files/2020/07/03/1267367/bat-mi-cong-thuc-lam-hau-chien-trung-cua-quan-ban-hon-100-phan-hau-chien-moi-ngay-202007031103470220.jpg',
    ...
    const gaRangMuoi = await this.prisma.recipe.create({
      data: {
        name: 'Gà Rang Muối ',
        imgUrl:
          'https://cdn.tgdd.vn/2021/11/CookRecipe/Avatar/ga-rang-muoi-thumbnail.jpg',
        description: `Bước 1: Sơ chế các nguyên liệu
    ...
    const bunCaNgu = await this.prisma.recipe.create({
      data: {
        name: 'Bún cá ngừ',
        imgUrl:
          'https://beptruong.edu.vn/wp-content/uploads/2021/03/mon-bun-ca-ngu.jpg',
    ...
    const mutVoBuoi = await this.prisma.recipe.create({
      data: {
        name: 'Mứt vỏ bưởi',
        imgUrl:
          'https://cdn.tgdd.vn/Files/2018/12/28/1141007/2-cach-lam-mut-vo-buoi-deo-thom-ngon-chuan-vi-lai-khong-bi-dang-202205251359144514.jpg',
    ...
    const mutChuoiSayKho = await this.prisma.recipe.create({
      data: {
        ...
        imgUrl:
          'https://mutsach.com/timthumb.php?src=upload/images/chuoi-say-deo-dat-biet-1kg-shop-mut-sach-cao-cap.jpg&w=500&h=0&zc=1&a=tc',
    ...
    const banhDucMan = await this.prisma.recipe.create({
      data: {
        ...
        imgUrl:
          'https://cdn.tgdd.vn/Files/2020/03/29/1245269/cach-lam-mon-banh-duc-man-mien-nam-ngon-de-thuc-hien-1-760x367.jpg',
    ...
    const xoiHoaDauBiec = await this.prisma.recipe.create({
      data: {
        ...
        imgUrl:
          'https://www.cet.edu.vn/wp-content/uploads/2019/04/xoi-hoa-dau-biec-deo-thom.jpg',
        description: `Bước 1: Sơ chế nguyên liệu
    ...
    const xoiComDua = await this.prisma.recipe.create({
      data: {
        name: 'Xôi cốm dừa',
        imgUrl:
          'https://www.cet.edu.vn/wp-content/uploads/2018/12/xoi-com-dua.jpg',
        description: `Bước 1: Sơ chế nguyên liệu
    ...
    const cachNauCanhKimChiHanQuoc = await this.prisma.recipe.create({
      data: {
        ...
        imgUrl:
          'https://cdn.tgdd.vn/Files/2019/04/17/1161301/cach-nau-canh-kim-chi-han-quoc-thom-ngon-dam-vi-202109281344057075.jpg',
        description: `"Bước 1: Sơ chế nguyên liệu
          Thịt bò mua về, bạn đem rửa sạch rồi để ráo nước, sau đó cắt thành những lát mỏng vừa ăn. Lưu ý, phải cắt ngang thớ để thịt mềm, dễ ăn nhé!
          Kim chi Hàn Quốc, bạn chia nước và cải ra thành hai phần. Phần cải bạn tiến hành vắt ráo nước rồi cắt thành những miếng vừa ăn. Còn nước kim chi bạn nếm xem vị cay đã vừa miệng chưa, nếu chưa có thể cho thêm một ít ớt bột Hàn Quốc. Cách làm này vừa tạo màu đẹp vừa tạo độ cay chuẩn vị cho cách nấu canh kim chi đậu phụ và thịt bò kiểu Hàn Quốc này.
          Tỏi tây rửa sạch, để ráo nước rồi đập dập, băm nhỏ.
    ...
    const canhGheRauMuong = await this.prisma.recipe.create({
      data: {
        ...
        imgUrl:
          'https://cdn.tgdd.vn/Files/2019/06/19/1174230/vao-bep-lam-canh-ghe-rau-muong-ngot-thanh-10_800x450.jpg',
        description: `Bước 1: Sơ chế nguyên liệu
    ...
    const chaoKhoaiLangThitGa = await this.prisma.recipe.create({
      data: {
        ...
        imgUrl:
          'https://afamilycdn.com/150157425591193600/2021/2/22/recipe51498-cook-step5-637166119298668381-16139833668761456785753.jpg',
        description: `Bước 1: Sơ chế nguyên liệu
    ...
    const nuocChamAnVoiVitLuoc = await this.prisma.recipe.create({
      data: {
        ...
        imgUrl:
          'https://cdn.tgdd.vn/2020/06/CookProduct/Untitled-2-1200x676-4.jpg',
    ...
    const chimCutNuongMatOng = await this.prisma.recipe.create({
      data: {
        ...
        imgUrl:
          'https://cdn.tgdd.vn/Files/2022/05/14/1432518/x-cach-pha-nuoc-cham-vit-luoc-ngon-chuan-vi-tai-nha-202205160136156857.jpg',
    ...
    const cheDuaDam = await this.prisma.recipe.create({
      data: {
        name: 'Chè dừa dầm',
        imgUrl:
          'https://cdn.tgdd.vn/Files/2022/05/18/1433549/cach-lam-chim-cut-nuong-mat-ong-thom-ngon-thit-mem-va-tham-gia-vi-202205190744387189.jpg',
    ...
    const cheBaBa = await this.prisma.recipe.create({
      data: {
        name: 'Chè bà ba',
        imgUrl:
          'https://cdn.tgdd.vn/Files/2021/12/24/1406445/cach-lam-che-dua-dam-ngon-chuan-vi-hai-phong-tai-nha-202112240108007211.jpg',
        description: `Bước 1: Sơ chế nguyên liệu
    ...
    const monCaHapXiDau = await this.prisma.recipe.create({
      data: {
        ...
        imgUrl:
          'https://cdn.tgdd.vn/Files/2021/07/31/1372046/cach-nau-che-ba-ba-thom-ngon-dung-kieu-nam-bo-202201131512195982.jpg',
        description: `Bước 1: Sơ chế các nguyên liệu
    ...
    const goiSuaXoaiXanh = await this.prisma.recipe.create({
      data: {
        ...
        imgUrl:
          'https://i-giadinh.vnecdn.net/2022/06/01/Thanh-pham-1-1-1611-1654074619.jpg',
        description: `Bước 1: Sơ chế nguyên liệu
    ...
    const goiGaBapCai = await this.prisma.recipe.create({
      data: {
        name: 'Gỏi gà bắp cải',
        imgUrl:
          'https://cdn.tgdd.vn/2021/10/CookRecipe/Avatar/goi-ga-bap-cai-thumbnail.jpg',
    ...
    const nauSupGaNgoNam = await this.prisma.recipe.create({
      data: {
        ...
        imgUrl:
          'https://cdn.tgdd.vn/2021/09/CookRecipe/GalleryStep/thanh-pham-387.jpg',
        description: `Sơ chế nguyên liệu
    ...
    const nauSupChay = await this.prisma.recipe.create({
      data: {
        name: 'Nấu súp chay',
        imgUrl:
          'https://cdn.tgdd.vn/2020/09/CookProduct/Untitled-2-Recovered-1200x676-13.jpg',
        description: `Sơ chế nguyên liệu
