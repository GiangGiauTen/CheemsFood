...
const QuanLyDoCanMua = () => {
	...
	return (
		<div>
			<Table columns={columns} dataSource={toBuyListData} pagination={false} rowKey='toBuyListId' />

			<Modal title='Thông tin Đơn Hàng' visible={isModalVisible} onCancel={handleModalClose} footer={null}>
				{selectedRowData && <FoodDetail selectedRowData={selectedRowData} key={selectedRowData.toBuyListId} />}
			</Modal>
		</div>
	)
}
