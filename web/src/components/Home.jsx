import { TeamOutlined, HomeOutlined, BarChartOutlined, ContactsOutlined, LogoutOutlined } from '@ant-design/icons'
...
function Home() {
	...
	const items = [
		...
		getItem('Quản Lý Đồ Cần Mua', '_4', <ContactsOutlined />, [getItem('Cá Nhân', '4'), getItem('Nhóm', '41')]),
		getItem(
			<Button
				type='primary'
				onClick={() => {
